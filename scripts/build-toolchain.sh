...
# Assembler (as)
emcc -v -O2 `find riscv-gnu-toolchain/riscv-binutils-js/intl -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/zlib -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/opcodes -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/libiberty -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/libctf -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/bfd -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/gas -name \*.o` -o assets/js/riscv64-unknown-elf-as-bare.js -s WASM=1 -s ASSERTIONS=1 -lworkerfs.js -lfs.js -s NO_EXIT_RUNTIME=0 -s ALLOW_MEMORY_GROWTH=1 ${PROFILING_OPTS}

# Linker (ld)
emcc -v -O3 `find riscv-gnu-toolchain/riscv-binutils-js/intl -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/zlib -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/opcodes -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/libiberty -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/libctf -name \*.o` `find riscv-gnu-toolchain/riscv-binutils-js/bfd -name \*.o` `ls riscv-gnu-toolchain/riscv-binutils-js/ld/*.o` -o assets/js/riscv64-unknown-elf-ld-bare.js -s WASM=1 -s ASSERTIONS=1 -lworkerfs.js -lfs.js -s NO_EXIT_RUNTIME=0 -s ALLOW_MEMORY_GROWTH=1 ${PROFILING_OPTS}
